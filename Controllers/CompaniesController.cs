        ...
        public ActionResult Create(Company company)
        {
            if (ModelState.IsValid)
            {
                ...
                if (company.LogoFile != null)
                {
                    ...
                    if (response)
                    {
                        pic = string.Format("{0}/{1}.jpg", folder, file, company.CompanyId);
                        company.Logo = pic;
            ...
            ViewBag.DepartamentsId = new SelectList(CombosHelpers.GetDepartments(), "DepartamentsId", "Name", company.DepartamentsId);
            return View(company);
        }
